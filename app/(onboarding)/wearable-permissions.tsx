    ...
    <ThemedView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <ThemedText style={styles.copy}>
          The production build will request health metrics including HRV, sleep,
          and active calories. Explain why the permission is needed and how data
          is secured.
        </ThemedText>
        <ThemedText style={styles.copy}>
          This modal also documents the flow: connect → fetch tokens → store
          encrypted in Supabase → schedule sync.
        </ThemedText>
      </View>
