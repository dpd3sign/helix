...
const rituals = [
  { title: 'Morning Identity Prompt', detail: '“What evidence will you create today that supports your chosen identity?”' },
  { title: 'Midday Affirmation', detail: 'Timed with workouts or key meals to reinforce precision.' },
  { title: 'Evening Reappraisal', detail: 'Reframe any friction logged during the day.' },
];
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={[styles.panel, { backgroundColor: palette.surface, borderColor: palette.borderMuted }]}>
          ...
          <ThemedText style={styles.panelCopy}>
            The mindset system structures guided journaling, affirmations, and micro-habit feedback to keep identity front and center.
          </ThemedText>
        </View>
        ...
        <View style={styles.shortcuts}>
          {shortcuts.map(shortcut => (
            <Link key={shortcut.label} href={shortcut.href} asChild>
              <Pressable style={[styles.shortcutCard, { backgroundColor: palette.surface, borderColor: palette.borderMuted }]}>
                <ThemedText type="defaultSemiBold">{shortcut.label}</ThemedText>
                <ThemedText style={styles.shortcutHint}>Tap to open prototype flow.</ThemedText>
              </Pressable>
            </Link>
          ))}
        </View>
        ...
        <View style={styles.sectionHeader}>
          ...
          <ThemedText style={styles.sectionCopy}>
            Scaffold of touch points that will evolve as the AI coach personalizes routines.
          </ThemedText>
        </View>
        ...
        <View style={styles.backlog}>
          {backlog.map(task => (
            <View
              ...
              style={[
                styles.backlogItem,
                { backgroundColor: `${palette.tint}0D`, borderColor: `${palette.tint}33` },
              ]}
            >
